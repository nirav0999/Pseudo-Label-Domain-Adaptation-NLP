...
def loadPickleFile(filepath, verbose = False):
    if verbose == True : 
...
def dumpPickleFile(data,filepath, verbose = False):
...
def dumpJsonFile(dictionary, filepath, verbose = False):
    ...
    if verbose == True : print("Dumped Successfully",filepath)

def loadJsonFile(filepath, verbose = False):
